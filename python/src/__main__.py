...
file1_path = 'python/data/USAB Rankings Sep 2024.xlsx - August2024AllPlayerPoints.csv'
file2_path = 'python/data/USAB Rankings Sep 2024.xlsx - August2024FinalPlayer_rankings.csv'
